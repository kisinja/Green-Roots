  ...
  if (step === "done") {
    return (
      <div className="text-center py-16">
        ...
        <a
          href="/orders"
          className="bg-[#2a7a2a] text-white px-6 py-3 rounded-xl font-semibold hover:bg-[#163e16] transition-all"
        >
          View My Orders →
        </a>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-5 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-green-400 transition-all"
          />
        </div>
        <div>
          <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide">
